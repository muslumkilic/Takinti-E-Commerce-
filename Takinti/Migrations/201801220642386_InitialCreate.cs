namespace Takinti.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        RatingCount = c.Single(nullable: false),
                        ...
                        CreateDate = c.DateTime(nullable: false),
                        Updateate = c.DateTime(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
                ...
                c => new
                    {
                        ...
                        ParengCategoryId = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Categories", t => t.ParengCategoryId)
                .Index(t => t.ParengCategoryId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Categories", "ParengCategoryId", "dbo.Categories");
            ...
            DropIndex("dbo.Categories", new[] { "ParengCategoryId" });
